...
public class DecisionTreeDemo {
	public static void main(String[] args) {
		...
		questionTree.swapChildren();
		System.out.println("All Answers should be wrong: ");
		while (!done) {
			BinaryTree left = questionTree.left();
			BinaryTree right = questionTree.right();
			if (left.isEmpty() && right.isEmpty()) {
		...
		System.out.println();
		System.out.println("# of leaves = "+questionTree.numLeaves());
		System.out.println("# of nodes with one child = "+questionTree.numNodesWithOneChild());
	}
}
